...
namespace BiggyTry
{
    ...
    // add file compression above of other store, which knowns how to serialize objects.
    //
    ...
    public class CompressedStore<T> : Biggy.FileSystemStore<T>, IBiggyStore<T> where T : new()
    {
        // Decorated store which knows how to serialize (like JsonStore)
        ...
        // to file in case of adding items.
