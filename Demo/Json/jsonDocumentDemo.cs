...
namespace Demo {
  public class jsonDocumentDemo {
    ...
    jsonChinookDb _testDb;
    jsonChinookDb _chinookDb;

    string _testDbName = "JsonTestData";
    string _chinookDbName = "ChinookData";

    public void Run() {
      Console.WriteLine("JSON Document Demo - TEST DATA");
      Console.WriteLine("==============================");
      ...
      sw.Stop();
      Console.WriteLine("");
      Console.WriteLine("Wrote all {0} complex artist documents to JSON Store in {1} ms", _testDb.ArtistDocuments.Count, sw.ElapsedMilliseconds);
